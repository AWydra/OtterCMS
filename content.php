...
<div id="promo" class="tabcontent">
    <div class="tab pb-0 pb-sm-2 row mx-1" style="border: none;">
        <button class="col-6 col-sm-auto tablinks py-2" id="button1" style="transition: none; border:#ccc solid 2px;">1</button>
        <button class="col-6 col-sm-auto tablinks py-2" id="button2" style="transition: none;">2</button>
    </div>
