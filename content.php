    ...
    <form action="promobox.php" method="post">
        ...
        <div class="row">
            ...
            <fieldset class="form-group col-sm-6">
                ...
                <div class="form-check">
                    <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="status" id="enable" value="block" <?php if ($status == 'block'){
                            echo 'checked';
                        } ?>
            ...
            <fieldset class="form-group col-sm-6">
                ...
                <div class="form-check">
                    <label class="form-check-label">
                        <input type="radio" class="form-check-input" name="counterstatus" id="counterenable" value="block" <?php if ($counterstatus == 'block'){
                            echo 'checked';
                        } ?>>
                        Enabled
                    </label>
